...
(function () {
  ...
  // Riwayat lokal cuma buat nampilin ulang bubble di browser ini kalau reload —
  // BUKAN sumber data admin. Sumber data admin ada di Firestore (avenor_chats).
  ...
  // Render ulang bubble yang sudah ada (kalau user buka lagi setelah reload halaman)
